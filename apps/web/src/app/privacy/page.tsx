      ...
      <main className="mx-auto max-w-3xl px-6 py-10 space-y-8 text-sm leading-relaxed">
        ...
        <Section title="4. 개인정보의 보유 및 이용 기간">
          <ol className="list-decimal space-y-1 pl-5">
            <li>
              회원 탈퇴 또는 수집·이용 목적 달성 시, 회원을 식별할 수 있는
              개인정보(이름·휴대폰 번호·학교·학년 등)는 지체 없이 파기합니다.
            </li>
            <li>
              시험 응시 결과·출결 등 학습 이력은 개인을 식별할 수 있는 정보를
              제거(익명 처리)한 형태로 보존하여, 통계 및 재등록 시 이력 제공
              목적으로만 활용합니다.
            </li>
            <li>
              회원이 직접 작성한 학습 일지 등 자유 서술 정보는 회원 탈퇴 시
              파기합니다.
            </li>
            <li>
